    ...
    return (
        <div className='mt-10'>
            ...
            <div>
                ...
                <p className='textxl font-semibold'>Name :</p>
                <p className='textxl font-semibold'>Email :</p>
                <p className='textxl font-semibold'>Phone :</p>
                <p className='textxl font-semibold'>Location :</p>

            </div>

            <div>
                <h1 className='text-2xl mt-5'>Edcucation information</h1>
                <p className='textxl font-semibold'>School :</p>
                <p className='textxl font-semibold'>College :</p>
                <p className='textxl font-semibold'>University :</p>
            ...
            <div>
                ...
                <p className='textxl font-semibold'>Linkedin profile Link :</p>
